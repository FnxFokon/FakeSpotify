 ...
 */
final class Version20231019083940 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP avatar_id, DROP image_path');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE user ADD avatar_id INT DEFAULT NULL, ADD image_path VARCHAR(255) DEFAULT NULL');
